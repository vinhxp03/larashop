...
<div class="card mb-4">
  <div class="card-header">Thêm mới category</div>
  <div class="card-body">
    <form action="" method="post">
      <div class="form-group">
      	{{ csrf_field() }}
        <label for="exampleFormControlInput1">Tên danh mục</label>
        <input type="text" class="form-control @if ($errors->has('cate_name')) {{ 'is-invalid' }} @endif" name="cate_name" placeholder="" value="{{ old('cate_name') }}">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @if ($errors->has('cate_decription')) {{ 'is-invalid' }} @endif" name="cate_decription" placeholder="" value="{{ old('cate_decription') }}">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @if ($errors->has('cate_url')) {{ 'is-invalid' }} @endif" name="cate_url" placeholder="" value="{{ old('cate_url') }}">
